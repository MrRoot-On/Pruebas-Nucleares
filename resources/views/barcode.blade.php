...
<head>
    ...
    <title>Testing barcode On Root</title>
</head>
<body>
...
<div class="col-md-8 col-md-offset-2">
    <h1 class="text-primary" style="text-align: center;">Testing barcode ON</h1>
...
<img src="data:image/png;base64,{{DNS2D::getBarcodePNG('Obed Nava Hk', 'PDF417')}}" alt="barcode" />
